...
// PS: the component's style lable must cancel scoped property that will generate a random string in class(data-v-xxx), we should promise our components can generate a stable class and can be rewrite by other developers
<style lang="scss">
$h: 32px;
$border-color: #d9d9d9;
$color: #333;
